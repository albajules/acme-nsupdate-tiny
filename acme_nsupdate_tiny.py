...
def main(argv):
    ...
    parser.add_argument("--tsig-key", default=None, help="nsupdate TSIG key string or path to key file")
    ...
    if args.tsig_key:
        if os.path.exists(args.tsig_key):
             with open(args.tsig_key, 'r') as f: args.tsig_key = f.read().strip()
