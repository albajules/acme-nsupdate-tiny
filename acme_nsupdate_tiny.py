...
def _nsupdate(cmd, key):
    if key and "\n" in key: raise ValueError("TSIG key must not contain newlines")
...
def main(argv):
    ...
    parser.add_argument("--tsig-key", default=None, help="nsupdate TSIG key, e.g. \"hmac-sha256:keyname secret\" or file")
